...
echo "127.0.1.1 arch.localdomain arch" >> /etc/hosts  #i think arch.localdomain should be swapped with PanArch - because thats my hostname .. whats the other 'arch' at the end of the sentence though.
